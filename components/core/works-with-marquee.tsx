...
function MarqueeTrack({
  ...
  return (
    <div
      aria-hidden={hidden}
      className={cn("flex w-max items-center gap-6 px-0 sm:gap-10 sm:px-5", className)}
    >
...
export default function WorksWithMarquee() {
  return (
    <div className="relative w-full bg-background">
      ...
      <div className="flex w-full flex-col items-stretch gap-3 py-4 sm:flex-row sm:items-center sm:gap-6 sm:py-5">
        <p className="shrink-0 px-4 text-center text-xs font-medium tracking-wide text-muted-foreground uppercase sm:px-0 sm:text-left sm:text-sm">
          Works With
        </p>
